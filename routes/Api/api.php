...
use App\Http\Controllers\Api\Customer\ContactAddController;
use App\Http\Controllers\Api\Customer\CustomerController;
use App\Http\Controllers\Api\Subscription\StripeController;
use App\Http\Controllers\Api\Tag\TagController;
use App\Http\Controllers\Api\User\DocsController;
...
Route::controller(HomepageController::class)->middleware('auth.jwt')->group(function () {
    ...
    Route::get('/upcoming-tasting', 'upcomingTasting');
});
...
/**
 * customer add from contact  
 **/
Route::controller(ContactAddController::class)->middleware('auth.jwt')->group(function () {
    Route::post('/import-form-contact', 'importFormContact');  //import from contact 
    Route::post('/import-form-google', 'importFormGoogle');  //import from google 
    Route::post('/import-form-card', 'importFormCard');  //import from scan a bussiness Card  
});
...
require "v2/notes/notes.php";

/**
 *user docs route
 */
Route::controller(DocsController::class)->middleware('auth.jwt')->group(function () {
    Route::get('/user-docs-list', 'index');
    Route::post('/user-docs-create', 'create');
    Route::get('/user-docs-details/{id}', 'details');
    Route::delete('/user-docs-destroy/{id}', 'destroy');
});
/**
 * csv file upload
 */
